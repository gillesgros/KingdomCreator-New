  ...
  <div class="content Coef_scale12 card-rows " >
    <div v-for="Card in Cards" :key="Card.id" :class="getClassCard(Card)">
      ...
      <!-- is a card -->
        ...
        <div class="full-card-art" :style='"background-size: 287px 374px; background-image: url(" + Card.artwork + "); top:12%;"' >
...
export default class CardOnlineOthercardPageComponent extends Vue {
  ...
  //console.log(OtherCards_list.filter(card => this.set.otherCards.some(function(item) { return (item.shortId == card.id); })))
